...
L["Raid Note Image Background"] = "Raid Note Image Background"
L["Personal Note Image Background"] = "Personal Note Image Background"
L["Image"] = "Raid Note Background Image"
